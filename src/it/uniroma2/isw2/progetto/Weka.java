...
public class Weka {
				...
				)
		{
			...
			for(int version=2;version<=maxversion;version++) {
				...
				testing.setClassIndex(numAttrNoFilter - 1);
				              ...
				              forEachFeatureSelection(noFilterTraining,testing,version,fileWriter,projectName);
	...
	private void forEachFeatureSelection( Instances noFilterTraining, Instances testing,int version,FileWriter fileWriter, String projectName) throws Exception {
